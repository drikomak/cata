...
with open('algo/hurdat2.txt', 'r') as file:
    for line in file:
        if line.startswith('AL'):
            ...
            wind_radii = parts[8:-1]  # Assume the last value is a placeholder and exclude it
...
# Appliquez la fonction de conversion aux colonnes 'Lat' et 'Long'
df['Lat'] = df['Lat'].apply(convert_coordinates)
df['Long'] = df['Long'].apply(convert_coordinates)

# Sauvegardez le DataFrame modifié dans un nouveau fichier CSV
